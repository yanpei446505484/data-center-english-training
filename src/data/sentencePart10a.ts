...
export const MOCK_SENTENCES_PART10A: ISentence[] = [
  {
    id: 271,
    en: "All medium-voltage switchboards are operating normally.",
    cn: "所有中压开关柜运行正常。",
    ipa: "/ɔːl ˈmiː.di.əm ˈvoʊl.tɪdʒ ˈswɪtʃ.bɔːrdz ɑːr ˈɑː.pə.reɪ.tɪŋ ˈnɔːr.mə.li/",
    tags: ["第271句", "电气系统", "★★★★★"],
    when: "天气巡检完成后，进入电气系统检查。第一句话汇报中压开关柜整体状态，中压系统是数据中心供电的核心入口。",
    words: [
      { w: "medium-voltage", ipa: "/ˈmiː.di.əm ˈvoʊl.tɪdʒ/", pos: "形容词", cn: "中压的", memory: "① medium = 中等的；② voltage = 电压。\nmedium-voltage = 中压（通常1kV-35kV）。\n数据中心供电层级：高压（HV 132kV）→ 中压（MV 11kV/33kV）→ 低压（LV 400V/230V）。", phonics: "medium 读 /ˈmiː.di.əm/，voltage 读 /ˈvoʊl.tɪdʒ/。", collocations: [["medium-voltage switchboard", "中压开关柜"], ["medium-voltage cable", "中压电缆"], ["medium-voltage transformer", "中压变压器"]], examples: [["The medium-voltage system is stable.", "中压系统运行稳定。"], ["Check the medium-voltage panel.", "检查中压配电盘。"]] },
      { w: "switchboard", ipa: "/ˈswɪtʃ.bɔːrd/", pos: "名词", cn: "开关柜；配电盘", memory: "① switch = 开关；② board = 板/柜。\nswitchboard = 开关柜（配电设备的总称，包含断路器、保护继电器、仪表等）。", phonics: "switch 读 /swɪtʃ/，board 读 /bɔːrd/。", collocations: [["main switchboard", "主开关柜"], ["distribution switchboard", "配电开关柜"], ["switchboard room", "配电室"]], examples: [["The switchboard alarm went off.", "开关柜告警响了。"], ["Inspect the switchboard daily.", "每天检查开关柜。"]] },
    ],
    phrases: [
      { p: "operating normally", ipa: "/ˈɑː.pə.reɪ.tɪŋ ˈnɔːr.mə.li/", cn: "运行正常", why: "operating + normally = 运行正常。这是交接中最常用的状态描述，适用于所有设备系统。" },
    ],
    grammar: [
      { q: "为什么用 are operating 而不是 operate？", a: "are operating = 正在运行（现在进行时，强调当前状态）\noperate = 运行（一般现在时，强调常态/事实）\n✅ All switchboards are operating normally.（所有开关柜正在正常运行 → 交接时汇报当前状态）\n✅ Switchboards operate at 11kV.（开关柜在11kV下运行 → 描述设计参数）\n交接时用进行时，因为关心的是'此刻的运行状态'。" },
    ],
    ...
    pronunciation: "medium 的 e 读长音 /iː/：/ˈmiː.di.əm/。\nvoltage 的 o 读 /oʊ/：/ˈvoʊl.tɪdʒ/。\nswitchboard 的 sw 读 /sw/，不要读成 /s/。\n节奏：ALL ME-di-um VOL-tage SWITCH-boards ｜ are OP-er-a-ting NOR-mal-ly.",
    quiz: [
      { q: "所有低压开关柜运行正常，怎么说？", a: "All low-voltage switchboards are operating normally." },
  ...
  {
    id: 272,
    en: "There are no protection trips.",
    cn: "没有发生保护跳闸。",
    ipa: "/ðeər ɑːr noʊ prəˈtɛk.ʃən trɪps/",
    tags: ["第272句", "电气系统", "★★★★★"],
    ...
    grammar: [
      { q: "There are no protection trips 和 No protection trips occurred 有什么区别？", a: "There are no protection trips = 没有保护跳闸（当前状态，强调'不存在'）\nNo protection trips occurred = 没有发生保护跳闸（过去动作，强调'没有发生'）\n✅ There are no protection trips.（没有跳闸 → 交接时简洁汇报）\n✅ No protection trips occurred during the last shift.（上一班期间没有跳闸 → 更精确）\n两者都正确，交接时用 There are no 更简洁。" },
    ],
    pattern: "There are no + 异常事件",
    patternExamples: [
      { en: "There are no breaker trips.", cn: "没有断路器跳闸。", words: [{ w: "breaker", ipa: "/ˈbreɪkər/", cn: "断路器", phonics: "break 读 /breɪk/，er 读 /ər/" }] },
      { en: "There are no power outages.", cn: "没有停电。", words: [{ w: "power", ipa: "/ˈpaʊər/", cn: "电力", phonics: "pow 读 /paʊ/，er 读 /ər/" }] },
      { en: "There are no equipment failures.", cn: "没有设备故障。", words: [{ w: "equipment", ipa: "/ɪˈkwɪpmənt/", cn: "设备", phonics: "e 读 /ɪ/，quipment 读 /kwɪpmənt/" }] },
    ],
    thinking: "保护跳闸是电气系统最重要的异常指标。\n有跳闸 = 有故障 → 需要查原因、恢复、记录。\n无跳闸 = 系统正常 → 一句话带过。\n交接时先确认有没有跳闸，再汇报正常运行参数。",
    pronunciation: "protection 重音在第二音节：/prəˈtɛk.ʃən/。\ntrips 的 tr 读 /tr/，不要读成 /tʃ/。\n节奏：There are NO ｜ pro-TEC-tion TRIPS.",
    quiz: [
      { q: "没有发生断路器跳闸，怎么说？", a: "There are no breaker trips." },
  ...
  {
    id: 284,
    en: "The wall fan units are operating normally.",
    cn: "风墙空调运行正常。",
    ipa: "/ðə wɔːl fæn juːnɪts ɑːr ˈɑː.pə.reɪ.tɪŋ ˈnɔːr.mə.li/",
    tags: ["第284句", "暖通系统", "★★★★"],
    when: "汇报完冷却塔后，报告风墙空调状态。风墙空调是一种侧送风制冷设备，安装在机房墙壁上，适合高密度机房。",
    words: [
      { w: "wall fan", ipa: "/wɔːl fæn/", pos: "名词", cn: "风墙（空调）", memory: "① wall = 墙壁；② fan = 风机/风扇。\nwall fan unit = 风墙空调机组（安装在墙壁上的大型送风制冷设备）。\n风墙空调与传统CRAC不同：CRAC从下方送风（地板下送风），风墙从侧面水平送风。\n适合高密度机房或没有架空地板的区域。", phonics: "wall 读 /wɔːl/，fan 读 /fæn/。", collocations: [["wall fan unit", "风墙空调机组"], ["wall-mounted unit", "壁挂式机组"], ["side airflow", "侧送风"]], examples: [["The wall fan supply temperature is 18°C.", "风墙送风温度18°C。"], ["Check the wall fan filter.", "检查风墙滤网。"]] },
    ],
    phrases: [
      { p: "wall fan units", ipa: "/wɔːl fæn juːnɪts/", cn: "风墙空调机组", why: "wall fan + units = 风墙空调机组。交接时与CRAC分开汇报，因为风墙和CRAC是不同的制冷设备类型。" },
    ],
    grammar: [
      { q: "风墙空调和CRAC有什么区别？", a: "CRAC（精密空调）：\n- 安装方式：落地式，从地板下方送风（下送风）\n- 适用场景：有架空地板的传统机房\n- 送风方向：向上\n\n风墙空调（Wall Fan）：\n- 安装方式：壁挂式，从侧面水平送风（侧送风）\n- 适用场景：高密度机房、无架空地板区域\n- 送风方向：水平\n两者可能同时存在于同一个数据中心，交接时分别汇报。" },
    ],
    pattern: "The wall fan units + are operating normally",
    patternExamples: [
      { en: "The wall fan units are operating normally.", cn: "风墙空调运行正常。", words: [{ w: "operating", ipa: "/ˈɒpəreɪtɪŋ/", cn: "运行中", phonics: "op 读 /ɒp/，erating 读 /əreɪtɪŋ/" }, { w: "normally", ipa: "/ˈnɔːrməl/", cn: "正常", phonics: "nor 读 /nɔːr/，mal 读 /məl/" }] },
      { en: "Wall fan No.3 has a high temperature alarm.", cn: "3号风墙有高温告警。", words: [{ w: "temperature", ipa: "/ˈtɛmpərətʃər/", cn: "温度", phonics: "temp 读 /tɛmp/，erature 读 /ərətʃər/" }, { w: "alarm", ipa: "/əˈlɑːrm/", cn: "告警", phonics: "a 读 /ə/，larm 读 /lɑːrm/" }] },
      { en: "All wall fan filters have been replaced.", cn: "所有风墙滤网已更换。", words: [{ w: "filters", ipa: "/ˈfɪltər/", cn: "过滤器", phonics: "fil 读 /fɪl/，ter 读 /tər/" }] },
    ],
    thinking: "暖通设备汇报顺序：\n① CRAC（传统精密空调）\n② 冷冻水系统\n③ 冷却塔\n④ 风墙空调（本句）\n⑤ 湿度\n每种设备单独汇报状态，让接班人全面了解制冷系统运行情况。",
    pronunciation: "wall 的 a 读长音 /ɔː/：/wɔːl/。\nfan 的 a 读短音 /æ/：/fæn/。\n节奏：The WALL FAN U-nits ｜ are OP-er-a-ting NOR-mal-ly.",
    quiz: [
      { q: "3号风墙有高温告警，怎么说？", a: "Wall fan No.3 has a high temperature alarm." },
      { q: "风墙空调和CRAC的送风方式有什么不同？", a: "CRAC = 下送风（从架空地板下方送冷风，气流向上）。\n风墙空调 = 侧送风（从墙壁侧面水平送冷风）。\n风墙适合高密度机架或没有架空地板的区域。" },
    ],
  },
  {
    id: 285,
