...
export const MOCK_SENTENCES_PART3B: ISentence[] = [
  ...
  {
    id: 88,
    en: "Please continue to monitor the rack with the high inlet temperature.",
    cn: "请继续监控进风温度偏高的机柜。",
    ipa: "/pliːz kənˈtɪn.juː tə ˈmɒn.ɪ.tər ðə ræk wɪð ðə haɪ ˈɪn.let ˈtem.prə.tʃər/",
    tags: ["第88句", "持续监控", "★★★★★"],
    when: "对之前发现的温度略高的机柜（第81句），要求接班人员持续关注，确保不会恶化。这是交接中的关键责任移交。",
    words: [
      { w: "continue", ipa: "/kənˈtɪn.juː/", pos: "动词", cn: "继续", memory: "continue to monitor = 继续监控，表示接班后延续当前监控任务。", phonics: "con-TIN-ue，重音在第二音节。", collocations: [["continue to monitor", "继续监控"], ["continue to investigate", "继续调查"], ["continue to track", "继续跟踪"]], examples: [["Please continue to monitor the alarm.", "请继续监控该告警。"], ["We will continue to investigate the issue.", "我们将继续调查该问题。"]] },
      { w: "inlet", ipa: "/ˈɪn.let/", pos: "名词/定语", cn: "入口；进风口", memory: "rack inlet temperature 指机柜服务器进风侧的温度，是判断冷却是否正常的重要指标。", phonics: "IN-let，重音在第一音节。", collocations: [["rack inlet temperature", "机柜进风温度"], ["air inlet", "进风口"], ["inlet sensor", "进风传感器"]], examples: [["Check the rack inlet temperature.", "检查机柜进风温度。"], ["The inlet temperature is slightly high.", "进风温度略高。"]] },
      { w: "temperature", ipa: "/ˈtem.prə.tʃər/", pos: "名词", cn: "温度", memory: "high inlet temperature = 进风温度偏高。这里明确说明需要监控的异常，而不是笼统地称机柜“异常”。", phonics: "TEM-per-a-ture，重音在第一音节。", collocations: [["inlet temperature", "进风温度"], ["high temperature", "高温"], ["temperature trend", "温度趋势"]], examples: [["Please check the temperature trend.", "请检查温度趋势。"], ["The temperature is back within range.", "温度已恢复到正常范围。"]] },
    ],
    phrases: [
      { p: "continue to monitor", ipa: "/kənˈtɪn.juː tə ˈmɒn.ɪ.tər/", cn: "继续监控", why: "交接班时用于明确要求接班人员延续当前的监控任务，比把 continuously 放在句末更自然。" },
      { p: "rack with the high inlet temperature", ipa: "/ræk wɪð ðə haɪ ˈɪn.let ˈtem.prə.tʃər/", cn: "进风温度偏高的机柜", why: "直接说明该机柜的具体异常，信息比笼统的 abnormal rack 更准确。" },
    ],
    grammar: [
    ...
    pattern: "Please continue to monitor + 具体对象/异常",
    patternExamples: [
      { en: "Please continue to monitor the UPS.", cn: "请继续监控UPS。", words: [{ w: "monitor", ipa: "/ˈmɒnɪtər/", cn: "监控", phonics: "mon 读 /mɒn/，itor 读 /ɪtər/" }, { w: "ups", ipa: "/ˌjuːˈpiːˈɛs/", cn: "不间断电源", phonics: "U-P-S 逐字母读" }] },
    ...
    thinking: "continue to monitor 是交接中的责任移交表达，说明该异常尚未升级，但接班人员必须延续监控。\n同时明确说出 high inlet temperature，能让接班人员立刻知道需要关注的具体参数。",
    pronunciation: "continue 重音在第二音节：con-TIN-ue。\nmonitor 重音在第一音节：MON-i-tor。\ninlet 和 temperature 的重音都在第一音节。\n节奏：Please con-TIN-ue to MON-i-tor ｜ the RACK ｜ with the high IN-let TEM-per-a-ture.",
    quiz: [
